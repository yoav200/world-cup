ALTER TABLE match DISABLE TRIGGER USER;
ALTER TABLE team DISABLE TRIGGER USER;
ALTER TABLE group_match DISABLE TRIGGER USER;
ALTER TABLE knockout_match DISABLE TRIGGER USER;
ALTER TABLE bet DISABLE TRIGGER USER;
ALTER TABLE account DISABLE TRIGGER USER;
ALTER TABLE knockout_team DISABLE TRIGGER USER;
ALTER TABLE match_result DISABLE TRIGGER USER;
ALTER TABLE user_bet DISABLE TRIGGER USER;
ALTER TABLE qualifier DISABLE TRIGGER USER;
...
ALTER TABLE match ENABLE TRIGGER USER;
ALTER TABLE team ENABLE TRIGGER USER;
ALTER TABLE group_match ENABLE TRIGGER USER;
ALTER TABLE knockout_match ENABLE TRIGGER USER;
ALTER TABLE bet ENABLE TRIGGER USER;
ALTER TABLE account ENABLE TRIGGER USER;
ALTER TABLE knockout_team ENABLE TRIGGER USER;
ALTER TABLE match_result ENABLE TRIGGER USER;
ALTER TABLE user_bet ENABLE TRIGGER USER;
ALTER TABLE qualifier ENABLE TRIGGER USER;
