ALTER TABLE match DISABLE TRIGGER;
ALTER TABLE team DISABLE TRIGGER;
ALTER TABLE group_match DISABLE TRIGGER;
ALTER TABLE knockout_match DISABLE TRIGGER;
ALTER TABLE bet DISABLE TRIGGER;
ALTER TABLE account DISABLE TRIGGER;
ALTER TABLE knockout_team DISABLE TRIGGER;
ALTER TABLE match_result DISABLE TRIGGER;
ALTER TABLE user_bet DISABLE TRIGGER;
ALTER TABLE qualifier DISABLE TRIGGER;
...
ALTER TABLE match ENABLE TRIGGER;
ALTER TABLE team ENABLE TRIGGER;
ALTER TABLE group_match ENABLE TRIGGER;
ALTER TABLE knockout_match ENABLE TRIGGER;
ALTER TABLE bet ENABLE TRIGGER;
ALTER TABLE account ENABLE TRIGGER;
ALTER TABLE knockout_team ENABLE TRIGGER;
ALTER TABLE match_result ENABLE TRIGGER;
ALTER TABLE user_bet ENABLE TRIGGER;
ALTER TABLE qualifier ENABLE TRIGGER;
