...
ALTER TABLE group_match DISABLE TRIGGER ALL;
ALTER TABLE knockout_match DISABLE TRIGGER ALL;
ALTER TABLE bet DISABLE TRIGGER ALL;
ALTER TABLE account DISABLE TRIGGER ALL;
ALTER TABLE knockout_team DISABLE TRIGGER ALL;
ALTER TABLE match_result DISABLE TRIGGER ALL;
ALTER TABLE user_bet DISABLE TRIGGER ALL;
ALTER TABLE qualifier DISABLE TRIGGER ALL;
...
ALTER TABLE group_match ENABLE TRIGGER ALL;
ALTER TABLE knockout_match ENABLE TRIGGER ALL;
ALTER TABLE bet ENABLE TRIGGER ALL;
ALTER TABLE account ENABLE TRIGGER ALL;
ALTER TABLE knockout_team ENABLE TRIGGER ALL;
ALTER TABLE match_result ENABLE TRIGGER ALL;
ALTER TABLE user_bet ENABLE TRIGGER ALL;
ALTER TABLE qualifier ENABLE TRIGGER ALL;
