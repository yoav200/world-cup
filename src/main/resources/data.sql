...
INSERT INTO bet (id, desription, matchId, stageId, type) VALUES
  ...
  (49, 'ROS1 Match Result',49,'ROUND_OF_16', 'MATCH'),
  (50, 'ROS2 Match Result',50,'ROUND_OF_16', 'MATCH'),
  (51, 'ROS3 Match Result',51,'ROUND_OF_16', 'MATCH'),
  (52, 'ROS4 Match Result',52,'ROUND_OF_16', 'MATCH'),
  (53, 'ROS5 Match Result',53,'ROUND_OF_16', 'MATCH'),
  (54, 'ROS6 Match Result',54,'ROUND_OF_16', 'MATCH'),
  (55, 'ROS7 Match Result',55,'ROUND_OF_16', 'MATCH'),
  (56, 'ROS8 Match Result',56,'ROUND_OF_16', 'MATCH'),
  (57, 'QF1 Match Result',57,'QUARTER_FINAL', 'MATCH'),
  (58, 'QF2 Match Result',58,'QUARTER_FINAL', 'MATCH'),
  (59, 'QF3 Match Result',59,'QUARTER_FINAL', 'MATCH'),
  (60, 'QF4 Match Result',60,'QUARTER_FINAL', 'MATCH'),
  (61, 'SF1 Match Result',61,'SEMI_FINAL', 'MATCH'),
  (62, 'SF2 Match Result',62,'SEMI_FINAL', 'MATCH'),
  (63, 'Third Place Match Result',63,'THIRD_PLACE', 'MATCH'),
  (64, 'Final Match Result',64,'FINAL', 'MATCH');

INSERT INTO bet (id, desription, stageId, type) VALUES
  (65, 'Number 1 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (66, 'Number 2 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (67, 'Number 3 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (68, 'Number 4 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (69, 'Number 5 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (70, 'Number 6 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (71, 'Number 7 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (72, 'Number 8 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (73, 'Number 9 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (74, 'Number 10 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (75, 'Number 11 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (76, 'Number 12 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (77, 'Number 13 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (78, 'Number 14 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (79, 'Number 15 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (80, 'Number 16 Qualifier to Round Of 16','ROUND_OF_16', 'QUALIFIER'),
  (81, 'Number 1 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (82, 'Number 2 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (83, 'Number 3 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (84, 'Number 4 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (85, 'Number 5 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (86, 'Number 6 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (87, 'Number 7 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (88, 'Number 8 Qualifier to Quarter final','QUARTER_FINAL', 'QUALIFIER'),
  (89, 'Number 5 Qualifier to Semi final','SEMI_FINAL', 'QUALIFIER'),
  (90, 'Number 6 Qualifier to Semi final','SEMI_FINAL', 'QUALIFIER'),
  (91, 'Number 5 Qualifier to Semi final','SEMI_FINAL', 'QUALIFIER'),
  (92, 'Number 6 Qualifier to Semi final','SEMI_FINAL', 'QUALIFIER'),
  (93, 'Number 1 Qualifier to Final','FINAL', 'QUALIFIER'),
  (94, 'Number 2 Qualifier to Final','FINAL', 'QUALIFIER'),
  (95, 'Third Place','THIRD_PLACE', 'QUALIFIER'),
  (96, 'Winner','WINNER', 'QUALIFIER');
