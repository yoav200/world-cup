...
CREATE TABLE public.coin_event
(
    id              bigint NOT NULL,
...
ALTER TABLE ONLY public.match
    ALTER COLUMN matchid SET DEFAULT nextval('public.match_matchid_seq'::regclass);

ALTER TABLE ONLY public.ranking
    ALTER COLUMN id SET DEFAULT nextval('public.ranking_id_seq'::regclass);
...
ALTER TABLE ONLY public.coin_event
    ADD CONSTRAINT coin_event_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.coin_event
    ADD CONSTRAINT fk_coin_event_account FOREIGN KEY (account_id) REFERENCES public.account (id);
...
CREATE TABLE public.league_membership
(
    id          bigint NOT NULL,
...
ALTER TABLE ONLY public.league_membership
    ADD CONSTRAINT league_membership_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.league_membership
    ADD CONSTRAINT uk_league_membership UNIQUE (league_id, email);

ALTER TABLE ONLY public.league
    ADD CONSTRAINT fk_league_creator FOREIGN KEY (created_by) REFERENCES public.account (id);

ALTER TABLE ONLY public.league_membership
    ADD CONSTRAINT fk_league_membership_league FOREIGN KEY (league_id) REFERENCES public.league (id);

ALTER TABLE ONLY public.league_membership
    ADD CONSTRAINT fk_league_membership_account FOREIGN KEY (account_id) REFERENCES public.account (id);
